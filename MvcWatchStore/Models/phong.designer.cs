...
namespace MvcWatchStore.Models
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="phong")]
	public partial class phongDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteTHUONGHIEU(THUONGHIEU instance);
		...
		public phongDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["phongConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public phongDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public phongDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public phongDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public phongDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnMaTHChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Tendongho", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
